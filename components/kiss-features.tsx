...
const features = [
  ...
  },
  {
    ...
    title: "Fast Payouts",
    description:
      "Enjoy quick and hassle-free withdrawals with our efficient payment processing system that ensures you get your winnings promptly.",
  },
  {
...
export default function KissFeatures() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Why Choose <span className="text-casino-gold">918KISS</span>
          </h2>
        ...
        >
          <button className="btn-red">Download 918KISS Now</button>
        </motion.div>
      </div>
    </section>
  )
