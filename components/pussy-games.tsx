...
export default function PussyGames() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Best <span className="text-casino-gold">Games</span> in PUSSY888
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Explore our collection of exciting games with massive jackpots and thrilling gameplay
          </p>
        </motion.div>
